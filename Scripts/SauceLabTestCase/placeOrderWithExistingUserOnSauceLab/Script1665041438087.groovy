...
WebUI.setText(findTestObject('Object Repository/sauceLabLoginObjects/Page_Swag Labs/Page_Swag Labs/input_standard_userlocked_out_userproblem_u_db77ac'), 
    'standard_user')

WebUI.setEncryptedText(findTestObject('Object Repository/sauceLabLoginObjects/Page_Swag Labs/Page_Swag Labs/input_standard_userlocked_out_userproblem_u_3423e9'), 
    'qcu24s4901FyWDTwXGr6XA==')

WebUI.sendKeys(findTestObject('Object Repository/sauceLabLoginObjects/Page_Swag Labs/Page_Swag Labs/input_standard_userlocked_out_userproblem_u_3423e9'), 
...
WebUI.click(findTestObject('Object Repository/sauceLabLoginObjects/Page_Swag Labs/Page_Swag Labs/a_2'))
...
WebUI.click(findTestObject('Object Repository/sauceLabLoginObjects/Page_Swag Labs/Page_Swag Labs/input_Checkout Your Information_lastName'))
