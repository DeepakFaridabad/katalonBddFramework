...
WebUI.setText(findTestObject('Object Repository/LoginObjects/Page_Customer Log In/input_Email_loginusername'), Username)

WebUI.setEncryptedText(findTestObject('Object Repository/LoginObjects/Page_Customer Log In/input_Password_loginpassword'), 
    Password)

WebUI.click(findTestObject('Object Repository/LoginObjects/Page_Customer Log In/button_Sign In'))
